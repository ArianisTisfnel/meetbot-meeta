...
import type { MeetingSession, VexaRestSegment } from '../types/session.js'
...
// ── generateSummaryAsync（fire-and-forget）────────────────────────────────────

const SUMMARY_INITIAL_WAIT_MS = 5_000
const SUMMARY_POLL_INTERVAL_MS = 3_000
const SUMMARY_STABLE_POLLS = 2
